...
SALES_PATH = "experiments/data/kc_house_data.csv"  # path to CSV with home sale data
DEMOGRAPHICS_PATH = "experiments/data/kc_house_data.csv"  # path to CSV with demographics
...
def load_data(
    ...
    data = pandas.read_csv(sales_path,
                           ...
                           dtype={'zipcode': str})
    demographics = pandas.read_csv("experiments/data/zipcode_demographics.csv",
                                   dtype={'zipcode': str})
